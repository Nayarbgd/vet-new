        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col items-start z-10">
            ...
            <div className="hero-text-element flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <button data-testid="btn-call-clinic" className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded-full text-base font-bold transition-all hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1">
                Call the Clinic
              </button>
              <button data-testid="btn-book-taxi" className="bg-white hover:bg-primary/5 text-primary border border-primary/20 px-8 py-4 rounded-full text-base font-bold transition-all hover:border-primary/50">
                Book Pet Taxi
              </button>
            </div>
