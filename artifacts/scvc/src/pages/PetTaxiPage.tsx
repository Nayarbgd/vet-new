...
export default function PetTaxiPage() {
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section ref={timelineRef} className="py-28 bg-background">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 relative">
            <div className="hidden lg:block absolute top-[3.5rem] left-[12%] right-[12%] h-0.5 bg-gradient-to-r from-transparent via-border to-transparent z-0"></div>
            {steps.map((step, idx) => (
              <div key={idx} className="timeline-step relative z-10 flex flex-col items-center text-center">
                <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-6 relative z-10 border-4 border-background shadow-md ${step.color}`}>
          ...
          <div className="text-center mt-16">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 rounded-full text-base font-bold transition-all hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-1"
            >
      ...
      <section ref={benefitsRef} className="py-24 bg-secondary/30">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((b, i) => (
              <div key={i} className="benefit-card bg-card border border-border rounded-3xl p-7 hover:shadow-md transition-shadow">
                <div className="bg-primary/10 p-3 rounded-2xl w-fit mb-5">
            ...
            <div className="relative">
              <div className="bg-secondary/50 rounded-[3rem] p-3 -rotate-2">
                <img
                  ...
                  alt="Pet being safely transported"
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {taxiTestimonials.map((t, i) => (
              <div key={i} className="bg-card border border-border rounded-3xl p-8 flex flex-col shadow-sm hover:shadow-md transition-shadow">
                <div className="flex gap-1 mb-6">
                  {[1,2,3,4,5].map(j => <Star key={j} className="w-4 h-4 fill-primary text-primary" />)}
                </div>
                <p className="font-serif text-lg text-foreground leading-relaxed flex-1 mb-8">"{t.quote}"</p>
      ...
      <section className="relative py-32 overflow-hidden bg-[#E11D79]">
        ...
        <div className="container mx-auto px-6 max-w-3xl text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/contact" className="inline-flex items-center justify-center gap-2 bg-white text-[#E11D79] px-10 py-5 rounded-full text-lg font-bold hover:shadow-xl hover:scale-105 transition-all active:scale-95">
              <Car className="w-5 h-5" />
              Book Pet Taxi
            </Link>
